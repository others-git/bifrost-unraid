...
Bifrost brings your supported devices — direct integrations plus anything from Home
Assistant — under one web UI and REST API. It ships as a single binary with one SQLite
file, and runs from the published image `ghcr.io/others-git/bifrost:latest`. See the
[supported-device list](https://others-git.github.io/bifrost/providers/).
